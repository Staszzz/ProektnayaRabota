...
public class CalendarEventsPage extends AbsBasePage {
    private Logger logger = LogManager.getLogger(CalendarEventsPage.class);
    ...
    public CalendarEventsPage checkVisibilityCardsEvent() {
        ...
        logger.info("check visibility cards event success");
        return this;
    ...
    public CalendarEventsPage checkStartDateEvent() {
        ...
        logger.info("Date events are earlier than the current one success");
        return this;
    }
    ...
    public CalendarEventsPage selectSortedEventsType(EventTypeData eventTypeData) {
        ...
        logger.info("Open webinars sorted success");
        return this;
    }
    ...
    public CalendarEventsPage checkEventsType(EventTypeData eventTypeData) {
        ...
        logger.info("Check 'Open webinars' on everyone cards  success");
        return this;
    }
